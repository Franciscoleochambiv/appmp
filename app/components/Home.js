...
export default function Home(props) {
    ...
    const getData = () => {
        ...
        //OPTION 2 - FAKE API
        let url = "https://munichamaca.sytes.net:7006/api/articulos/viewsql";
        //"https://my-json-server.typicode.com/mesandigital/demo/quotes";
    ...
    //5 - EDIT QUOTE
    const onEdit = (item) => {
        alert("No tiene permisos para realizar la edicion")
